...
/// <summary>
/// Parser that decodes Liquid/HTML pages, extracting YAML frontmatter and preserving layout markup.
/// </summary>
public class LiquidContentParser : IContentParser
{
    private readonly IDeserializer _yamlDeserializer;

    public LiquidContentParser()
    {
    ...
    public async Task<ContentDocument> ParseAsync(string filePath)
    {
        ...
        if (fileContent.StartsWith("---"))
        {
            ...
            if (endOfFrontmatterIndex > 0)
            {
                ...
                var liquid = fileContent.Substring(endOfFrontmatterIndex + 3).Trim();
